...
public interface CountryRepository extends JpaRepository<Country, Long> {
  ...
  @Query(value =
      "SELECT c, COUNT(a.id) as airportCount FROM Country c JOIN Airport a ON c.code = a.isoCountry\n"
          +
  ...
  List<Country> findByNameContainsIgnoreCaseOrKeywordsContainsIgnoreCase(String countryName,
