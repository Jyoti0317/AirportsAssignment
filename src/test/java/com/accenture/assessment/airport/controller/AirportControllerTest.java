...
public class AirportControllerTest {
  ...
  public void testGetRunwaysForCountryCode() throws Exception {
    List<RunwayResponseDto> runways = new ArrayList<>();
    when(airportService.getRunways("NL")).thenReturn(runways);
    RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/airport/runways")
        .queryParam("countryName", "NL");
